        ...
        <Container fluid>
          <Row className="takeData">
            <Col md={6} className="bg-primary">
              <h1 className="display-5 pb-5 mb-3 text-center pt-5 text-white ">
                {" "}
                Add User{" "}
              </h1>{" "}
              <ComponentsAdd
            ...
            <Col md={6} className="user bg-white ">
              <h1 className="display-5 mx-auto text-center pb-5 mb-2 pt-5 text-dark">
                {" "}
                Saved Users{" "}
              </h1>{" "}
