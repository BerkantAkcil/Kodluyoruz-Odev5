...
export const ComponentsAcordion = ({
  ...
  <Accordion
    id="accordionid"
    className="acordion justify-content-center mx-auto col-md-9"
  >
    <Card>
      <Accordion.Toggle
        id="accordiontog1"
        ...
        <Card.Body className="bg-secondary text-white">
          <ListGroup>
            {item.isEditing ? (
              ...
              <div>
                <Card.Title className="text-center font-italic font-weight-normal">
                  {item.name}
                </Card.Title>

                <Row className="justify-content-center  font-italic mb-2">
                  <Card.Text className="px-4 col-6 font-size-large text-center">
                ...
                <Row className="mb-4">
                  <Card.Text className="notes px-4 font-size-large font-italic">
